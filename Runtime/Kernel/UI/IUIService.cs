...
namespace Tritone.UI
{
    ...
    {
        /// <summary>Creates one module-owned window availability scope.</summary>
        /// <returns>A new window scope.</returns>
        IUIWindowScope CreateScope();

        /// <summary>Opens one currently available window.</summary>
